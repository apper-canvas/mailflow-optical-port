...
const Button = forwardRef(({ 
  ...
  const variants = {
primary: "bg-primary hover:bg-red-700 text-white shadow-sm hover:shadow-md focus:ring-primary/20",
    secondary: "bg-gray-100 hover:bg-gray-200 text-gray-700 border border-gray-300 focus:ring-gray-300/20",
    ghost: "text-gray-700 hover:text-gray-900 hover:bg-gray-100 focus:ring-gray-300/20",
